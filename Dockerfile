...
COPY lifecoach_mcp.py /app/lifecoach_mcp.py
COPY genui_mcp.py /app/genui_mcp.py
COPY templates/ /app/templates/
COPY start.sh /app/start.sh
COPY install_gbrain.sh /app/install_gbrain.sh
RUN chmod +x /app/start.sh /app/install_gbrain.sh /app/constellation_mcp.py /app/lifecoach_mcp.py /app/genui_mcp.py
